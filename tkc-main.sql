...
--    INSERT INTO rpipe VALUES('r5.2.1', 'dm(dm_icd,dm_icpc):{1=1 => GREATEST(dm_icd,dm_icpc)} ;');
...
--    
    --INSERT INTO rpipe VALUES('7.1','rrt_hd_ld(hd_icd,hd_icpc,hd_proc):{hd_icd is null AND hd_icpc is null AND hd_proc is null=>null},{hd_icd is not null AND hd_icpc is not null AND hd_proc is not null=>greatest(hd_icd,hd_icpc,hd_proc)},{=>null}');
    INSERT INTO rpipe VALUES('7.2','rrt_hd_ld(hd_icd,hd_icpc,hd_proc):{1=1 => coalesce(hd_icd,hd_icpc,hd_proc)}');
