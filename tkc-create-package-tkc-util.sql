...
function transform_h2_ana(txt_in varchar2) return integer
as
ret integer;
/*
Report 1

Event Result Definition	Result Component	Result Desc
ANTI NUCLEAR AB ENQUIRIES (ANA-0)	ANTI NUCLEAR FACTOR	EQUIVOCAL \.BR\
ANTI NUCLEAR AB ENQUIRIES (ANA-0)	ANTI NUCLEAR FACTOR	NEGATIVE
ANTI NUCLEAR AB ENQUIRIES (ANA-0)	ANTI NUCLEAR FACTOR	POSITIVE \.BR\
ANTI NUCLEAR AB ENQUIRIES (ANA-0)	ANTI NUCLEAR FACTOR	POSITIVE (SSA/RO)
ANTI NUCLEAR AB ENQUIRIES (ANA-0)	ANTI NUCLEAR FACTOR	TITRE 1:160
ANTI NUCLEAR AB ENQUIRIES (ANA-0)	ANTI NUCLEAR FACTOR	TITRE 1:320
ANTI NUCLEAR AB ENQUIRIES (ANA-0)	ANTI NUCLEAR FACTOR	TITRE > 1:640
ANTI NUCLEAR AB ENQUIRIES (ANA-0)	ANTI NUCLEAR FACTOR	TITRE 1:640
ANTI NUCLEAR AB ENQUIRIES (ANA-0)	ANTI NUCLEAR FACTOR	TITRE 1:80
ANTI NUCLEAR AB ENQUIRIES (ANA-0)	ANTI NUCLEAR FACTOR	TITRE: 1 IN 320 \.BR\

*/
begin
    case
        when txt_in in ('NEGATIVE') then ret:=0;
        else ret:=1;
    end case;
end transform_h2_ana ;
