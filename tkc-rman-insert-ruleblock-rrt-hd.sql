...
--    -- END OF RULEBLOCK --
    ...
    rb.picoruleblock:='
        ...
        loc_mode_1m_txt : {hd_131000_pri_loc in (111721600013032,150721600013032 ) => `NTG-TEHS-NRU`},
        {hd_131000_pri_loc in (111721600015062,150721600015062,111721600006002 ) => `NTG-TEHS-7A`},
        {hd_131000_pri_loc in (111721500008032,111721600013032,111721500016042,150721500016042 ) => `FM-TE-KDH`},
        {hd_131000_pri_loc in (111721600013012,111721600015052,150721600013012 ) => `NTG-TEHS-HT`},
        {hd_131000_pri_loc in (111721600005012,111721600014022,150721600005012 ) => `NTG-TEHS-PRH`},
