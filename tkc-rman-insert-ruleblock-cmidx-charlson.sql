...
BEGIN
    ...
    rb.picoruleblock:='
        ...
        chf => eadv.[icd_i09_9, icd_i11_0, icd_i13_0, icd_i13_2, icd_i25_5, icd_i42_0,
                    ...
                    icd_i43%, icd_i50%, icd_p29_0].dt.exists();
        ...
        dem => eadv.[icd_f00%, icd_f01%, icd_f02%, icd_f03%,
                    icd_f05_1, icd_g30%, icd_g31_1].dt.exists();
        ...
        pud => eadv.[icd_k25%, icd_k26%, icd_k27%, icd_k28%].dt.exists();
        ...
        met => eadv.[icd_c77%, icd_c78%, icd_c79%, icd_c80%].dt.exists();
