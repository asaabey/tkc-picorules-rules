...
DELETE FROM rman_rpt_templates WHERE compositionid='cds_template';
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','frame_main_header','dmg_loc',200001,'dev','tkc',TO_DATE(SYSDATE),
    '
    <style>
                .syn_alert_box {
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','frame_synthesis_begin','dmg_loc',600010,'dev','tkc',TO_DATE(SYSDATE),
    '
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','frame_synthesis_left_begin','dmg_loc',600011,'dev','tkc',TO_DATE(SYSDATE),
    '
    <div>
    '
    );
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','frame_synthesis_left_end','dmg_loc',609001,'dev','tkc',TO_DATE(SYSDATE),
    '
    </div>
    '
    );
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','frame_synthesis_end','dmg_loc',609010,'dev','tkc',TO_DATE(SYSDATE),
    '
    </div></div>
    '
    );
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','frame_recm_begin','dmg_loc',700001,'dev','tkc',TO_DATE(SYSDATE),
    '
    <hr />
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','frame_recm_end','dmg_loc',799999,'dev','tkc',TO_DATE(SYSDATE),
    '
    </div>
    '
    );
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','frame_notes_begin','dmg_loc',800001,'dev','tkc',TO_DATE(SYSDATE),
    '
    <hr />
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','frame_notes_end','dmg_loc',899999,'dev','tkc',TO_DATE(SYSDATE),
    '
    </small>
    </div>
    '
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','dmg_loc_summary','dmg_loc',200010,'dev','tkc',TO_DATE(SYSDATE),
    '
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','alert_tg4810','tg4810',304810,'dev','tkc',TO_DATE(SYSDATE),
    '
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','alert_tg4620','tg4620',304620,'dev','tkc',TO_DATE(SYSDATE),
    '
    <div class="syn_alert_box">
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','alert_tg4610','tg4610',304610,'dev','tkc',TO_DATE(SYSDATE),
    '
    <div class="syn_alert_box">
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','alert_tg4100','tg4100',304100,'dev','tkc',TO_DATE(SYSDATE),
    '
    <div class="syn_alert_box">
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','alert_tg4410','tg4410',304410,'dev','tkc',TO_DATE(SYSDATE),
    '
    <div class="syn_alert_box">
    <h5>
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','alert_tg4720','tg4720',304720,'dev','tkc',TO_DATE(SYSDATE),
    '
    <div class="syn_alert_box">
    <h5>
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','alert_tg4660','tg4660',304660,'dev','tkc',TO_DATE(SYSDATE),
    '
    <div class="syn_alert_box">
    <h5>
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','alert_tg2610','tg2610',302610,'dev','tkc',TO_DATE(SYSDATE),
    '
    <div class="syn_alert_box">
    <h5>
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','cd_dm_syn_1','cd_dm',602100,'dev','tkc',TO_DATE(SYSDATE),
    '
    <ul>
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','cd_dm_rec_1','cd_dm',702100,'dev','tkc',TO_DATE(SYSDATE),
    '
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','cd_htn_syn_1','cd_htn',603100,'dev','tkc',TO_DATE(SYSDATE),
    '
    <ul>
        <li><b>Hypertension</b>
        <ul>
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','cd_htn_rec_1','htn_rcm',703100,'dev','tkc',TO_DATE(SYSDATE),
    '
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','cd_htn_footnote_1','cd_htn',801100,'dev','tkc',TO_DATE(SYSDATE),
    '
    <<iq_tier>>
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','cd_cardiac_syn','cd_cardiac',604100,'dev','tkc',TO_DATE(SYSDATE),
    '
    <ul>
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','rrt_syn','rrt',601000,'dev','tkc',TO_DATE(SYSDATE),
    '
    <ul>
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','cd_ckd_syn_1','ckd',601100,'dev','tkc',TO_DATE(SYSDATE),
    '
    <ul>
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','cd_ckd_syn_2','ckd',601199,'dev','tkc',TO_DATE(SYSDATE),
    '
    </ul>
    '
    );
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','rx_syn_1','rx_desc',651010,'dev','tkc',TO_DATE(SYSDATE),
    '
    <hr/>
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','cd_ckd_cause_syn_1','ckd_cause',601101,'dev','tkc',TO_DATE(SYSDATE),
    '<ul>
        <li>aetiology
            <ul>
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','cd_ckd_recm_1','ckd',701100,'dev','tkc',TO_DATE(SYSDATE),
    '
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','cd_ckd_recm_2','ckd_complications',701200,'dev','tkc',TO_DATE(SYSDATE),
    '
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','cd_ckd_footnote_1','ckd',801100,'dev','tkc',TO_DATE(SYSDATE),
    '
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','cd_cvra_syn_1','cvra',604100,'dev','tkc',TO_DATE(SYSDATE),
    '
    <ul>
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','cd_cvra_rec_1','cvra',704100,'dev','tkc',TO_DATE(SYSDATE),
    '
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','cd_cvra_footnote_1','cvra',804100,'dev','tkc',TO_DATE(SYSDATE),
    '
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','cd_ckd_journey_1','ckd_journey',601105,'dev','tkc',TO_DATE(SYSDATE),
    '
    <ul>
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','cd_ckd_dx_1','ckd_diagnostics',601110,'dev','tkc',TO_DATE(SYSDATE),
    '
    <ul>
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','cd_ckd_compx_1','ckd_complications',601120,'dev','tkc',TO_DATE(SYSDATE),
    '<ul>
...
--INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
--    VALUES('cds_template','graph_egfr','egfr_graph',651100,'dev','tkc',TO_DATE(SYSDATE),
--    '
--    <hr />
--    <div class="syn_synopsis_box">
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','graph_egfr2','egfr_graph2',651101,'dev','tkc',TO_DATE(SYSDATE),
    '
    <hr />
    <div class="syn_synopsis_box">
    <h5>Temporal variation of eGFR</h5>
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','graph_bp','bp_graph',653110,'dev','tkc',TO_DATE(SYSDATE),
    '
    <hr />
    <div class="syn_synopsis_box">
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','egfr_metrics','egfr_metrics',651110,'dev','tkc',TO_DATE(SYSDATE),
    '
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','ckd_labs_tbl1','ckd_labs',661100,'dev','tkc',TO_DATE(SYSDATE),
    '
    <hr />
    <div class="syn_synopsis_box">
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','ckd_labs_tbl2','ckd_labs',661101,'dev','tkc',TO_DATE(SYSDATE),
    '
        <tr class="syn_tr">
            <td>
...
INSERT INTO rman_rpt_templates (compositionid,templateid,ruleblockid,placementid,environment,template_owner,effective_dt,templatehtml)
    VALUES('cds_template','ckd_labs_tbl3','ckd_labs',661102,'dev','tkc',TO_DATE(SYSDATE),
    '
        <tr class="syn_tr">
            <td>CO2 (mmol/l)</td>
